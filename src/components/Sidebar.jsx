...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-black h-full flex flex-col">
      {/* Logo */}
      <div className="p-6">
        <svg className="h-10" viewBox="0 0 1134 340" fill="#fff">
      ...
      <nav className="flex-1">
          ...
          <li>
            <Link to="/search">
              <Button
                variant="ghost"
                className={`w-full justify-start text-base h-10 ${
                  isActive('/search') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white'
                }`}
              >
          ...
          <li>
            <Link to="/library">
              <Button
                variant="ghost"
                className={`w-full justify-start text-base h-10 ${
                  isActive('/library') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white'
                }`}
              >
        ...
        <div className="mt-6 px-3">
          <Button
            variant="ghost"
            className="w-full justify-start text-base h-10 text-gray-400 hover:text-white"
          >
          ...
          <Link to="/liked">
            <Button
              variant="ghost"
              className="w-full justify-start text-base h-10 text-gray-400 hover:text-white mt-2"
            >
              <Heart className="mr-4 h-6 w-6 fill-purple-500 text-purple-500" />
              Liked Songs
            </Button>
          </Link>
        </div>
        ...
        <div className="border-t border-gray-800 mt-4 pt-4 px-3">
          <div className="space-y-3">
            {['My Playlist #1', 'Discover Weekly', 'Release Radar', 'Chill Mix'].map((playlist, i) => (
              <button
                key={i}
                className="text-sm text-gray-400 hover:text-white block w-full text-left px-3 py-1 rounded transition-colors"
              >
                {playlist}
              </button>
            ))}
